...
python experiments_zero/train_vocab_embedding.py -b 256 -e 3 --lr 0.00001 -c "en-${LA}" -s "${EN_MODEL}" -t "vocabtrimmer/roberta-base.xnli-en.swap_${LA}_tokenizer.untrained" -o "ckpts/roberta-base.xnli-en.swap_${LA}.1" --repo-id "vocabtrimmer/roberta-base.xnli-en.swap_${LA}.1"
...
python experiments_zero/train_vocab_embedding.py -b 256 -e 3 --lr 0.00005 -c "en-${LA}" -s "${EN_MODEL}" -t "vocabtrimmer/roberta-base.xnli-en.swap_${LA}_tokenizer.untrained" -o "ckpts/roberta-base.xnli-en.swap_${LA}.2" --repo-id "vocabtrimmer/roberta-base.xnli-en.swap_${LA}.2"
...
python experiments_zero/train_vocab_embedding.py -b 256 -e 3 --lr 0.0001 -c "en-${LA}" -s "${EN_MODEL}" -t "vocabtrimmer/roberta-base.xnli-en.swap_${LA}_tokenizer.untrained" -o "ckpts/roberta-base.xnli-en.swap_${LA}.3" --repo-id "vocabtrimmer/roberta-base.xnli-en.swap_${LA}.3"
...
python experiments_zero/train_vocab_embedding.py -b 256 -e 3 --lr 0.0005 -c "en-${LA}" -s "${EN_MODEL}" -t "vocabtrimmer/roberta-base.xnli-en.swap_${LA}_tokenizer.untrained" -o "ckpts/roberta-base.xnli-en.swap_${LA}.4" --repo-id "vocabtrimmer/roberta-base.xnli-en.swap_${LA}.4"
...
python experiments_zero/train_vocab_embedding.py -b 256 -e 3 --lr 0.001 -c "en-${LA}" -s "${EN_MODEL}" -t "vocabtrimmer/roberta-base.xnli-en.swap_${LA}_tokenizer.untrained" -o "ckpts/roberta-base.xnli-en.swap_${LA}.5" --repo-id "vocabtrimmer/roberta-base.xnli-en.swap_${LA}.5"
...
python experiments_zero/train_vocab_embedding.py -b 256 -e 3 --lr 0.005 -c "en-${LA}" -s "${EN_MODEL}" -t "vocabtrimmer/roberta-base.xnli-en.swap_${LA}_tokenizer.untrained" -o "ckpts/roberta-base.xnli-en.swap_${LA}.6" --repo-id "vocabtrimmer/roberta-base.xnli-en.swap_${LA}.6"
